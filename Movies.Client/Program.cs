...
namespace Movies.Client
{
    class Program
    {
        ...
        private static void ConfigureServices(IServiceCollection serviceCollection)
        {
            ...
            //This registers MoviesClient with transient scope. The factory will automatically
            // create an instance of httpclient with whichever configuration
            //when an instance of MoviesClient is
            // requested from DI
            //serviceCollection.AddHttpClient<MoviesClient>(client =>
            //{
            //    client.BaseAddress = new Uri("http://localhost:57863");
